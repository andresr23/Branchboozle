...
/* ----------------------------- Exeriment -----------------------------------*/
#define EXPERIMENT "pht3b-covertc"
/*----------------------------------------------------------------------------*/
...
/* Repetitions to calculate transmission accuracy. */
 ...
 * Regardless of the micro-architecture, seven prime rounds suffice to move it
